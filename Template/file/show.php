        ...
        <div class="column-100">
                <table>
                    <tr>
                        ...
                        <th>
                          <input class="color" name="loginbackground_color" value="<?= (isset($customizer['cssparser']['body']['background-color'])) ? $customizer['cssparser']['body']['background-color'] : $this->task->configModel->get('loginbackground_color','#ffffff') ?>">
                        </th>
                    </tr>
                    <tr>
                        <th>
