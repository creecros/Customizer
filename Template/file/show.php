...
<div class="sidebar-content">
    ...
    <?php endif ?>
        ...
        <div class="panel" id="preview" style="background: url('<?= $customizer['backURL'] ?>') no-repeat center center cover;height: 700px;max-width: 1000px;background-color: <?= $customizer['backColor'] ?>;">
            <div>
