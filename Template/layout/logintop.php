...
<div id="login-top">
	<?php if ($this->configModel->exits('login_link')): ?><a href="<?php echo $this->configModel->getOptions('login_link', 'https://kanboard.org'); ?>" target="_blank"><?php endif ?>
	...
	<?php if ($this->configModel->exits('login_link')): ?></a><?php endif ?>
</div>
